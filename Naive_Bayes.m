...
%% Naive Bayes Model Implementation with parameters
       ...
       %F1 Score: 2x((PrecisionxRecall) /(Precision +Recall))
        ...
        Model1=fitcnb(data,'Purchased~Age+EstimatedSalary');
        % Test and Train
        ...
        Model2=fitcnb(data,'Purchased~Age+EstimatedSalary','DistributionNames','kernel');
        % Test and Train
